...
public class cal {
    static double[] grade = new double[8];
    static double[] credit = new double[8];
    static int C;
    public static void StyleOne(int C) {
    ...
    public static void StyleTwo(int C) {
        Scanner input = new Scanner(System.in);
        for (int k = 0; k < C; k++) {
            int period = k + 1;
            System.out.print("Enter your grade for period" + period + "--> ");
            ...
            if (w == 3) {
                if (grade[k] >= 93) {
                    grade[k] = 5.0;
                } else if ((92 >= grade[k]) && (grade[k] >= 90)) {
                    grade[k] = 4.7;
                } else if ((89 >= grade[k]) && (grade[k] >= 87)) {
                    grade[k] = 4.3;
                } else if ((86 >= grade[k]) && (grade[k] >= 83)) {
                    grade[k] = 4.0;
                } else if ((82 >= grade[k]) && (grade[k] >= 80)) {
                    grade[k] = 3.7;
                } else if ((79 >= grade[k]) && (grade[k] >= 77)) {
                    grade[k] = 3.3;
                } else if ((76 >= grade[k]) && (grade[k] >= 73)) {
                    grade[k] = 3.0;
                } else if ((72 >= grade[k]) && (grade[k] >= 70)) {
                    grade[k] = 2.7;
                } else if ((69 >= grade[k]) && (grade[k] >= 67)) {
                    grade[k] = 2.3;
                } else if ((66 >= grade[k]) && (grade[k] >= 65)) {
                    grade[k] = 2.0;
                } else if ((65 > grade[k])) {
                    grade[k] = 0.0;
                }
